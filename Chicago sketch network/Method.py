...
class Solve:
    def __init__(self):
        ...
        self.electric_quantity=30 # battery capacity

        self.charging_quantity_per_time=30
        ...
        self.column_generation_time=100
...
# 3. column generation process
            ...
            for od_index in range(self.g_number_of_ODs):
                ...
                #if OD pair is not feasible, we output it
                if len(self.g_ending_state_vector.state_vector)==0:
                    print(od_index+1)
            ...
            if i== self.column_generation_time-1:
                self.global_LB = obj_of_RMP
                print("Unnormal termination")
