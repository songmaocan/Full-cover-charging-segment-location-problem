class Read_data:
    ...
    def read_links(self):
        ...
        with open("candidate_charging_lanes_from_zero.txt","r") as fl:
            input_candidate_charging_index=[]
            line=fl.readlines()
            line_str = line[0].split(";")
            for item in line_str:
                input_candidate_charging_index.append(int(item))
        ...
        with open("links.txt","r") as fl:
            ...
            for line in lines[1:]:
                ...
                if link.link_id in input_candidate_charging_index:
